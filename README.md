...
```bash
curl -J -L -o release.tar.gz https://github.com/groupdocs-viewer/GroupDocs.Viewer-for-Java-Dropwizard/releases/download/1.14.24/release.tar.gz
tar -xvzf release.tar.gz
cd release
java -jar viewer-1.14.24.jar configuration.yaml
## Open http://localhost:8080/viewer/ in your favorite browser.
```
